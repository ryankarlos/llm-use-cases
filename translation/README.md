...
A serverless application that performs real-time translation and content flagging for customer service conversations. The service uses AWS Lambda, Amazon Bedrock, and Amazon Translate to process text and identify potentially concerning phrases.
...
- Content flagging for potentially concerning phrases
- Support for chat conversations
- Name anonymization
- Configurable rules for content flagging
